...
struct ImGuiContext
{
    ...
    ImU32                   ColorEditSavedColor;                // RGB value with alpha set to 0.// RGB value with alpha set to 0.
...
//#endif
    ...
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& bg_col, const ImVec4& tint_col, ImGuiButtonFlags flags);
